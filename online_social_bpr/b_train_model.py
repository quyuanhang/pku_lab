...
load_csv = utils.load_data_from_csv

training_data, users_to_index, items_to_index = load_csv('input/train.csv')
testing_data, users_to_index, items_to_index = load_csv('input/test.csv', users_to_index, items_to_index)
